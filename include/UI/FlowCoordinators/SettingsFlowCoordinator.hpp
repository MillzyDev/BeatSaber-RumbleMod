...
DECLARE_CLASS_CODEGEN(RumbleMod::UI::FlowCoordinators, SettingsFlowCoordinator, ::HMUI::FlowCoordinator,
    DECLARE_PRIVATE_FIELD(::GlobalNamespace::MainFlowCoordinator *, _mainFlowCoordinator);
    DECLARE_PRIVATE_FIELD(::RumbleMod::UI::ViewControllers::SettingsViewController *, _settingsViewController);
